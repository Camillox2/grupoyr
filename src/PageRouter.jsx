...
function PageFrame({ children }) {
  return <><a className="skip-link" href="#conteudo">Ir para o conteúdo</a><header className="site-header"><div className="container header-inner"><BrandLogo /><nav className="detail-nav" aria-label="Navegação principal"><a href="/#produtos">Equipamentos</a><a href="/comprar-ou-alugar">Comprar ou alugar</a><a href="/blog">Blog YR</a></nav><a className="header-cta" href="/#contato">Falar com a YR <span aria-hidden="true">→</span></a></div></header>
    ...
    <footer className="detail-footer"><div className="container"><div className="footer-brand-pair"><BrandLogo /><DeveloperCredit /></div><div><a href="/#produtos">Todos os equipamentos</a><a href="/comprar-ou-alugar">Guia de compra e locação</a><a href="/blog">Blog YR</a><a href={`mailto:${siteConfig.email}`}>{siteConfig.email}</a><a href={siteConfig.whatsappLink || `https://wa.me/${siteConfig.whatsapp}`} target="_blank" rel="noreferrer">WhatsApp: {siteConfig.whatsappLabel}</a></div><p>© 2026 Grupo YR Hospitalar. Modelos, disponibilidade e condições são confirmados na cotação.</p></div></footer></>
}
